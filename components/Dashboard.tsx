              ...
              return (
                ...
                >
                  ...
                  <div className={`${viewMode === 'grid' ? 'p-5' : 'flex-1 min-w-0 pr-4'}`}>
                    ...
                    <div className="mt-4">
                      {type === 'image' && hasFiles ? (
                        <div className="rounded-lg bg-gray-50 aspect-[2/1] flex items-center justify-center overflow-hidden border border-gray-100 relative">
                          <img
                            src={`/api/files/${item.files[0].id}`}
                          ...
                          <div className="absolute inset-0 hidden items-center justify-center bg-gray-50">
                            <Image size={32} className="opacity-20 text-gray-400" />
                          </div>
